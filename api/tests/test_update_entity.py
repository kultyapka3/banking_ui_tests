...
def test_update_entity_success(entity_service: EntityService) -> None:
    initial_title = 'update entity'
    initial_verified = False
    initial_important_numbers = [777, 777]
    initial_addition = AdditionRequest(additional_info='update additional', additional_number=777)
    ...
    # Получаем сущность
    initial_entity = entity_service.get_entity(created_id)
    ...
    updated_title = 'successful update entity'
    updated_verified = True
    updated_important_numbers = [666, 666]
    updated_addition = AdditionRequest(additional_info='updated additional', additional_number=666)

    update_data = EntityRequest(
        title=updated_title,
    ...
    updated_entity = entity_service.get_entity(created_id)
