...
def test_sort_customers_by_first_name(driver):
    ...
    initial_names = manager_page.get_customers_names()
    ...
    sorted_za_names = manager_page.get_customers_names()
    expected_za_names = sorted(initial_names, reverse=True)
    ...
    sorted_az_names = manager_page.get_customers_names()
    expected_az_names = sorted(initial_names)
